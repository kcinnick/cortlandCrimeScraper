...
def rename_charge_description(cleaned_charge_description):
    ...
    charges_to_rename = {
        ...
        'Drivers view obstructed': 'Driver\'s view obstructed',
        'Drivers view distorted': 'Driver\'s view obstructed',
        'Visibility distorted or broken glass': 'Driver\'s view obstructed',
